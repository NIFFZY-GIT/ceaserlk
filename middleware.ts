...
function createSecureRedirectResponse(url: string, request: NextRequest): NextResponse {
  ...
  const csp = [
    ...
    "connect-src 'self' blob: https://api.stripe.com https://checkout.stripe.com https://www.payhere.lk https://sandbox.payhere.lk https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://region1.google-analytics.com https://region1.analytics.google.com https://www.facebook.com https://connect.facebook.net https://platform.linkedin.com https://analytics.tiktok.com https://platform.twitter.com https://api.segment.com",
    "worker-src 'self' blob:",
    "frame-src https://checkout.stripe.com https://js.stripe.com https://www.payhere.lk https://sandbox.payhere.lk https://www.facebook.com https://www.instagram.com https://platform.linkedin.com https://analytics.tiktok.com https://platform.twitter.com",
    "object-src 'none'",
    "base-uri 'self'",
