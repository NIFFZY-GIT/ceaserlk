    ...
    <main ref={containerRef} className="overflow-x-hidden text-white bg-brand-black">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen p-6 text-center">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <Image src="/images/cont1.jpeg" alt="Abstract background" fill className="object-cover opacity-80" priority />
          ...
          <div className="absolute inset-x-0 top-[-10%] h-[100vh] bg-[radial-gradient(circle_farthest-side,rgba(78, 78, 78, 0.25),transparent)]"></div>
        </div>
