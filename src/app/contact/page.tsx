...
export default function ContactPage() {
  ...
  return (
    <main ref={containerRef} className="overflow-x-hidden text-white bg-brand-black">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-[80vh] sm:min-h-screen px-4 py-20 sm:p-6 text-center">
        {/* Background Elements */}
        <div className="absolute inset-0 z-0 overflow-hidden">
          <Image src="/images/cont1.jpeg" alt="Abstract background" fill className="object-cover object-[35%_center] sm:object-[60%_center]" priority />
