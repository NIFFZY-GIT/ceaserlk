...
function TrainMediaShowcase({
  ...
  return (
    <div
      ref={containerRef}
      // UPDATED: h-[55dvh] for mobile - removed even more space to bring details up
      className="relative w-full h-[55dvh] sm:h-[75dvh] md:h-screen bg-[#f5f5f5] overflow-hidden select-none touch-pan-y overscroll-x-contain"
            ...
            {item.type === "video" ? (
              ...
              <div className="relative w-full h-full">
                <Image
                  ...
                  // KEY UPDATE: sizes prop ensures mobile gets full width high-res image
            ...
            <div className="bg-white border border-[#e5e5e5] p-4 sm:p-6 space-y-5 sm:space-y-6 lg:sticky lg:top-6">
              ...
              <div className="border border-[#e5e5e5] bg-[#fafafa] rounded-md p-3 sm:p-4">
                <div className="flex items-center gap-3">
                  ...
                  {productId !== 'a22db2e3-5b1d-4ba5-9719-108be93965b2' && (
                    <>
