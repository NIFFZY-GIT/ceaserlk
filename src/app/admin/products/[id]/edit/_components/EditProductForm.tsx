                        ...
                        <div className="flex flex-wrap gap-2">
                           {existingColors.map(c => (
                            <button
                              ...
                              className="flex items-center gap-2 px-2 py-1 text-xs transition-all rounded-full bg-slate-100 text-slate-700 hover:bg-blue-500/10 hover:text-blue-600 hover:shadow-md active:scale-95 cursor-pointer"
