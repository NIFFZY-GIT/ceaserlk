            ...
            <div className="mt-4">
              ...
              {existingColors.length > 0 && (
                <div className="mt-4 p-3 bg-gray-50 rounded-md">
                  <label className="block text-xs font-medium text-gray-700 mb-2">Select from Existing</label>
                  <div className="grid grid-cols-1 gap-1 max-h-32 overflow-y-auto">
                    {existingColors.map((existingColor, index) => (
                      <button
                        ...
                        className="flex items-center gap-2 p-2 text-xs border border-gray-200 rounded hover:bg-white transition-colors text-left"
                      >
